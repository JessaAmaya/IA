...
def obtenerModelo(method,facesData,labels): 
    ...
    ruta_modelo = "D:/Escuela/Ultimooo/IA/EMOCIONES/dat/modelo" + method + ".xml"
    emotion_recognizer.write(ruta_modelo)
    #emotion_recognizer.write("model"+method+".xml")
    
dataPath = 'D:/Escuela/Ultimooo/IA/EMOCIONES/dat' #Cambia a la ruta donde hayas almacenado Data
